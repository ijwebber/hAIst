...
public class DifficultySettings : MonoBehaviourPun
{
    ...
    public void btnSaveClick() {
        ...
        defaultSettings.Add("scoreMultipler", (float)((moveSlider.value - 7)*2 + (radiusSlider.value-10)*2 + (4 - timerSlider.value)*2));
    ...
    public void SetupDifficulties() {
        ...
        moveMultiplier.text = (2*(moveSpeedSetting*2 - 7)).ToString() + "%";
        radiusMultiplier.text = ((radiusSetting-10)*2).ToString() + "%";
        timerMultiplier.text = ((4-timeSetting)*2).ToString() + "%";
        totalMultiplier.text = "Total: " + ((moveSlider.value - 7)*2 + (radiusSlider.value-10)*2 + (4 - timerSlider.value)*2).ToString() + "%";
    }
